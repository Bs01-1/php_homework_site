...
<div class="header_box">
    <div class="header_paths">
        <div class="header_path_box">
            <a href="/index.php"><img title="На главную" class="header_logo" src="/img/header/icon.ico" alt=''></a>
            <div class="header_path">Аренда</div>
            <div class="header_path">Продажа</div>
        </div>
        <?php if(\Classes\Auth::sessionCheck()): ?>
            <div class="header_path header_button"><a href="/pages/advertisement.php">Добавить объявление</a></div>
        <?php else: ?>
            <div class="header_auth_box">
                <div class="header_path header_button"><a href="/pages/register.php">Регистрация</a></div>
