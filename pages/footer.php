    <div class="footer_box_bottom">
        ...
        <div class="footer_btn_box_bottom"><a href="info#map">Карта сайта</a></div>
        <div class="footer_btn_box_bottom">Реклама</div>
        <div class="footer_btn_box_bottom footer_contacts_hover"><a href="info#contsacts">Контакты</a>
